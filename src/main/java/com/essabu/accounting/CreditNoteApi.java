...
/**
 * API client for credit note operations.
 * Endpoint base: /api/accounting/credit-notes
 */
public final class CreditNoteApi extends BaseApi {

    private static final String BASE = "/api/accounting/credit-notes";
