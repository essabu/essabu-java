...
/**
 * API client for coupon operations.
 * Endpoint base: /api/accounting/coupons
 */
public final class CouponApi extends BaseApi {

    private static final String BASE = "/api/accounting/coupons";

    public CouponApi(HttpClientWrapper http) {
        super(http);
    }
