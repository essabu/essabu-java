...
/**
 * API client for tax rate operations.
 * Endpoint base: /api/accounting/tax-rates
 */
public final class TaxRateApi extends BaseApi {

    private static final String BASE = "/api/accounting/tax-rates";
