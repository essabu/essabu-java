...
/**
 * API client for recurring invoice operations.
 * Endpoint base: /api/accounting/recurring-invoices
 */
public final class RecurringInvoiceApi extends BaseApi {

    private static final String BASE = "/api/accounting/recurring-invoices";

    public RecurringInvoiceApi(HttpClientWrapper http) {
        super(http);
    }
