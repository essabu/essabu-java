...
/**
 * API client for delivery note operations.
 * Endpoint base: /api/trade/delivery-notes
 */
public final class DeliveryNoteApi extends BaseApi {

    private static final String BASE = "/api/trade/delivery-notes";

    public DeliveryNoteApi(HttpClientWrapper http) {
        super(http);
    }
