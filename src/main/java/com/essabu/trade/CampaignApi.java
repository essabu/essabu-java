...
/**
 * API client for CRM campaign operations.
 * Endpoint base: /api/crm/campaigns
 */
public final class CampaignApi extends BaseApi {

    private static final String BASE = "/api/crm/campaigns";

    public CampaignApi(HttpClientWrapper http) {
        super(http);
    }
