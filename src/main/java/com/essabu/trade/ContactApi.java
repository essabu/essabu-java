...
/**
 * API client for CRM contact operations.
 * Endpoint base: /api/crm/contacts
 */
public final class ContactApi extends BaseApi {

    private static final String BASE = "/api/crm/contacts";

    public ContactApi(HttpClientWrapper http) {
        super(http);
    }
