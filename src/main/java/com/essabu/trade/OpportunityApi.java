...
/**
 * API client for CRM opportunity operations.
 * Endpoint base: /api/crm/opportunities
 */
public final class OpportunityApi extends BaseApi {

    private static final String BASE = "/api/crm/opportunities";

    public OpportunityApi(HttpClientWrapper http) {
        super(http);
    }
