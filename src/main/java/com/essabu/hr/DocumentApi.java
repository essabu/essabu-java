...
/**
 * API client for HR document operations.
 * Endpoint base: /api/hr/documents
 */
public final class DocumentApi extends BaseApi {

    private static final String BASE = "/api/hr/documents";
    ...
    public byte[] download(UUID id) {
        return http.getBytes(BASE + "/" + id + "/download");
    }
}
