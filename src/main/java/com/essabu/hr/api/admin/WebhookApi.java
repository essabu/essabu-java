...
import com.essabu.hr.model.admin.request.CreateWebhookRequest;
import com.essabu.hr.model.admin.request.UpdateWebhookRequest;
import com.essabu.hr.model.admin.response.WebhookDeliveryResponse;
import com.essabu.hr.model.admin.response.WebhookSubscriptionResponse;
...
/**
 * API client for managing webhook resources in the Essabu HR module.
 *
...
public final class WebhookApi extends BaseApi {
    ...
    private static final String BASE_PATH = "/api/hr/webhooks";
    ...
    public List<WebhookDeliveryResponse> getDeliveries(UUID id) {
        return http.get(BASE_PATH + "/" + id + "/deliveries",
                new TypeReference<>() {});
    }

    public void test(UUID id) {
        http.postVoid(BASE_PATH + "/" + id + "/test", null);
    }
}
