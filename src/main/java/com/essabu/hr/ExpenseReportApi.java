...
/**
 * API client for HR expense report operations.
 * Endpoint base: /api/hr/expense-reports
 */
public final class ExpenseReportApi extends BaseApi {

    private static final String BASE = "/api/hr/expense-reports";

    public ExpenseReportApi(HttpClientWrapper http) {
        super(http);
    }
