...
/**
 * API client for compliance incident operations.
 * Endpoint base: /api/compliance/incidents
 */
public final class IncidentApi extends BaseApi {

    private static final String BASE = "/api/compliance/incidents";

    public IncidentApi(HttpClientWrapper http) {
        super(http);
    }
