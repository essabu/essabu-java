...
/**
 * API client for milestone operations.
 * Endpoint base: /api/project/milestones
 */
public final class MilestoneApi extends BaseApi {

    private static final String BASE = "/api/project/milestones";

    public MilestoneApi(HttpClientWrapper http) {
        super(http);
    }
