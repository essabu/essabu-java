...
/**
 * Request payload for updating a trip log via the Essabu Asset API.
 *
 * This data transfer object carries the parameters required to update
 * a trip log resource through the Asset REST API. It is serialized
...
public class UpdateTripLogRequest {
}
