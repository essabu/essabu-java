...
/**
 * API client for vehicle operations.
 * Endpoint base: /api/asset/vehicles
 */
public final class VehicleApi extends BaseApi {

    private static final String BASE = "/api/asset/vehicles";

    public VehicleApi(HttpClientWrapper http) {
        super(http);
    }
